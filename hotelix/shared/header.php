    ...
    <nav class="bg-[--primary-color] p-4 shadow-md shadow-blue-200 fixed z-[1000] w-full backdrop-blur-[8px]">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-8">
                ...
                <div class="">
                    <a href="#"
                        class="py-2 bg-[--primary-color] border-2 border-blue-400 px-3 flex items-center hover:border-green-600 rounded-lg transition-all text-white">Book
                        Now</a>
                </div>
            </div>
        ...
        <div id="mobileMenu" class="md:hidden hidden bg-[--primary-color]">
            ...
            <div>
                <a href="#"
                    class="bg-[--primary-color] border-2 border-blue-400 px-3 flex items-center justify-center hover:border-green-600 transition-all py-2 rounded-lg text-white">Book
                    Now</a>
            </div>
