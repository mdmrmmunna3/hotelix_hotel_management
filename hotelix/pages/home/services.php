...
<body>
    <section class="grid lg:grid-cols-3 md:grid-cols-2 gap-5 md:mx-8 mx-4 py-5">
        ...
        <div
            ...
            <div
                ...
                <img src="<?php echo './hotelix/assets/services/cctv-camera.png' ?>" alt="security" class="w-[68px]">
            </div>
        ...
        <div
            ...
            <p class="text-center px-1">DTake a trivial example, which of us ever undertakes laborious physical obtain
                some
                advantage.</p>
        </div>
        ...
        <div
            ...
            <p class="text-center px-1">How all this mistake idea denonce all like to pleasure complete account off the
                system.
            </p>
        </div>
        ...
        <div
            ...
            <p class="text-center px-1">If you find a lower online rate, we will match it and give you an additional 25%
                off
                on your stay.</p>
        </div>
