...
<body>
    <section>
        ...
        <div class="relative w-full glide-08 overflow-hidden">
            <!-- Slides -->
            <div class="overflow-hidden text-center text-slate-500 md:mx-8 mx-4" data-glide-el="track">
                <div
    ...
    <script>
        var glide07 = new Glide('.glide-08', {
            ...
            breakpoints: {
                768: {
                    perView: 2,  // For tablets (1024px and smaller)
                },
                640: {
                    perView: 1,  // For mobile (768px and smaller)
                }
            },
            classes: {
