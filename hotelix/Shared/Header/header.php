...
<body>
    ...
    <nav class="bg-[--primary-color] p-4 shadow-md shadow-blue-200">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-8">
                <ul class="flex space-x-8">
                    <li
                        class="p-2 text-[--serondary-color] border-r-2 hover:text-white border-transparent hover:border-[--border-color] rounded-sm transition-all relative inline-block overflow-hidden group">
                        <span
                    ...
                    <li class="relative group ">
                        ...
                        <a
                            class="p-2 text-[--serondary-color] hover:bg-blue-500 hover:text-white border-r-2 border-transparent hover:border-[--border-color] rounded-sm transition-all flex items-center relative z-10">
                            About
                    ...
                    <li
                        class="p-2 text-[--serondary-color] hover:text-white border-r-2 border-transparent hover:border-[--border-color] rounded-sm transition-all relative inline-block overflow-hidden group">
                        <span
                            class="absolute inset-0 bg-blue-500 hover:text-white translate-x-[-110%] group-hover:translate-x-0 transition-transform duration-300 ease-out"></span>
                ...
                <div class="">
                    <a href="#"
                        class="py-2 bg-[--primary-color] border-2 border-blue-400 px-3 flex items-center hover:border-green-600 rounded-lg transition-all">Book
                        Now</a>
                </div>
            </div>
            ...
            <div class="md:hidden flex items-center">
                <button id="hamburger" class="text-[--secondary-color] focus:outline-none">
        ...
        <div id="mobileMenu" class="md:hidden hidden bg-[--primary-color]">
            <ul>
                ...
                <li
                    class="p-2 text-[--serondary-color] border-r-2 hover:text-white border-transparent hover:border-[--border-color] rounded-sm transition-all relative inline-block overflow-hidden group w-full">
                    <span
                        class="absolute inset-0 bg-blue-500  translate-x-[-110%] group-hover:translate-x-0 transition-transform duration-300 ease-out "></span>
                    <a href="#" class="relative z-10 ">Home</a>
                </li>
            ...
            <div>
                <a href="#"
                    class="bg-[--primary-color] border-2 border-blue-400 px-3 flex items-center justify-center hover:border-green-600 transition-all py-2 rounded-lg">Book
                    Now</a>
            </div>
